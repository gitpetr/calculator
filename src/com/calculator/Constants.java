...
public class Constants {
    ...
    public static final String[] ROMAN_NUMBERS = {"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X"};
    public static final String[] ROMAN_FULL_NUMBERS = {"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X",
